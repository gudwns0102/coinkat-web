    ...
    return (
      <div
        ...
        <div style={styles.container}>
          <div id="console-content" style={styles.content}>
            <Route
              exact
              path={`${match.url}/board`}
              component={() => <Consoles.ConsoleBoard shrink={shrinkLayout} />}
            />
            <Route
              exact
              path={`${match.url}/board/add`}
              component={Consoles.ConsoleBoardAdd}
            />
            <Route
              exact
              path={`${match.url}/board/:exchange/:name`}
              component={() => <Consoles.ConsoleBoardDetail shrink={shrinkLayout}/>}
            />
            <Route
              exact
              path={`${match.url}/push`}
              component={Consoles.ConsolePush}
            />
            <Route
              exact
              path={`${match.url}/push/add`}
              component={() => (
                <Consoles.ConsolePushAdd shrink={shrinkLayout} />
              )}
            />
          </div>
        </div>
